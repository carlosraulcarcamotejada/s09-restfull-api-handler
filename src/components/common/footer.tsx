...
const Footer = () => {
  return (
    <footer className="bg-background border-t px-4 dark:border-t-neutral-900">
      <div className="mx-auto w-full max-w-screen-xl@ p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link href="https://ui.shadcn.com/" className="flex items-center gap-x-4">
        ...
        <hr className="my-6 border-t-gray-400 sm:mx-auto dark:border-t-foreground-50 dark:border-t lg:my-8" />
